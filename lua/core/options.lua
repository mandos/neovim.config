...
o.list = false -- show white characters
o.listchars = "eol:¬,tab:>·,trail:~,extends:>,precedes:<,space:␣"
o.number = true -- set numbered lines
-- o.timeoutlen = 1000 -- time to wait for a mapped sequence to complete (in milliseconds)
-- o.timeoutlen = 0 -- Time in milliseconds to wait for a key code sequence to complete
-- o.signcolumn = "auto"
...
o.smarttab = true -- make insert tabs smarter again
o.softtabstop = 2 -- the numer of spaces that a <Tab> counts for while performing editing
